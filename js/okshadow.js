...
(function($){
  ...
  $("#exCollapsingNavbar2 .navbar-nav").append("<li style='margin-right: 12px;' class="nav-item"><a href='http://ashleymcnamara.github.io/learn_to_code/#golang'>Learn Go </a></li>")
